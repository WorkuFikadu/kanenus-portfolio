...
export default function Home() {
  return (
    <div className="bg-[#fcfdfd] text-gray-800 selection:bg-accent selection:text-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-16 lg:gap-24 py-32">
          <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-accent font-medium text-sm tracking-widest uppercase mb-8">
              ...
              Author • Creator • Cultural Leader
            </div>
            <h1 className="text-5xl md:text-7xl font-heading font-bold mb-6 leading-[1.1] text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-accent">
              Kanenus<br />Kasa Bayisa
            </h1>
            <p className="text-xl md:text-2xl font-light text-gray-300 mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
              Preserving cultural heritage, shaping modern African literature, and engaging global audiences through storytelling.
            </p>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-8">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-xs text-gray-400 uppercase tracking-widest">Leadership Roles</p>
              </div>
              <div className="w-px bg-white/10 hidden sm:block"></div>
              <div className="text-center lg:text-left">
          ...
          <div className="flex-1 flex justify-center lg:justify-end w-full order-1 lg:order-2">
            <div className="relative w-72 md:w-[22rem] aspect-[3/4] group">
              ...
              <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden shadow-2xl z-10 border-2 border-white/10">
                <img src="/profile.jpg" alt="Kanenus Kasa Bayisa" className="object-cover w-full h-full transform transition-transform duration-700 group-hover:scale-105" />
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl">
                    <p className="font-bold text-base">125K+ Community</p>
                    <p className="text-sm text-blue-200">Across Digital Platforms</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-white py-24 relative -mt-10 z-20 rounded-t-[3rem] shadow-[0_-15px_60px_rgba(0,0,0,0.12)]">
            ...
            {[
              {
                ...
                desc: "Invite Kanenus for inspiring keynotes on African literature, cultural preservation, and modern storytelling.",
                link: "/contact",
                cta: "Send Invitation"
              },
              {
                ...
                title: "Publications",
                desc: "Explore profound literature that bridges ancient traditions and contemporary African society.",
                link: "/books",
                cta: "View Books"
              },
              {
                ...
                title: "Media & Press",
                desc: "Watch recent interviews, television appearances, and discussions on cultural leadership.",
                link: "/media",
                cta: "Watch Now"
              }
            ].map((item, idx) => (
              <Link key={idx} href={item.link} className="p-8 rounded-2xl bg-gray-50 hover:bg-blue-50 border border-gray-100 hover:border-accent/20 transition-all duration-300 group flex flex-col">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1">
              ...
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-primary mb-8">
                Cultural Visionary,<br />Literary Pioneer
              </h2>
              <p className="text-lg text-gray-600 leading-loose mb-8">
                Kanenus Kasa Bayisa is a distinguished professional writer, PR strategist, and cultural ambassador. As <strong>PR Manager of the Oromia Writers Association</strong> and <strong>Director of the Shanan Gadaa Band</strong>, he tirelessly bridges the gap between age-old traditions and modern digital platforms — making culture accessible to the world.
              </p>
              <Link href="/about" className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-white font-semibold rounded-full hover:bg-accent transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                Full Biography
            ...
            <div className="flex-1 grid grid-cols-2 gap-5">
              {[
                { num: "125K+", label: "Social Media Followers" },
                { num: "3+", label: "Active Leadership Roles" },
                { num: "2026", label: "Book Publication Year" },
                { num: "5+", label: "Years of PR Experience" }
              ].map((s, i) => (
                <div key={i} className="p-8 bg-gray-50 rounded-2xl border border-gray-100 text-center hover:shadow-xl hover:border-accent/20 transition-all duration-300">
                  <p className="text-4xl font-heading font-bold text-primary mb-2">{s.num}</p>
      ...
      <section className="py-28 bg-gradient-to-br from-[#071324] via-[#0b1a30] to-[#122a4f] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-4xl relative z-10 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-heading font-bold mb-8">Join 125,000+ on Social Media</h2>
          <p className="text-gray-300 text-lg mb-14 max-w-2xl mx-auto">
            Follow Kanenus's cultural journey across Facebook, TikTok, and YouTube for the latest insights, news, and behind-the-scenes content.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <a href="https://t.me" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 px-6 py-3.5 bg-[#0088cc] text-white font-bold rounded-full hover:opacity-90 transition-all duration-300 shadow-md">
      ...
      <section className="py-28 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-primary">A Life in Culture</h2>
          </div>
          
          {/* Static 3-image showcase using first gallery items */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[0, 1, 2].map(i => (
              <div key={i} className="aspect-[4/5] rounded-2xl overflow-hidden bg-gray-100 shadow-lg group">
                <img src={`/gallery/${i === 0 ? '541162491_2943637469155328_6917349338980761886_n.jpg' : i === 1 ? '542215310_2944985872353821_1862807247037575291_n.jpg' : '543118958_2947552745430467_1368589313288512120_n.jpg'}`} alt={`Cultural moment ${i+1}`} className="w-full h-full object-cover transform transition duration-700 group-hover:scale-110" />
              </div>
            ))}
          </div>

          <div className="text-center">
            <Link href="/gallery" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-primary text-primary font-semibold rounded-full hover:bg-primary hover:text-white transition-all duration-300">
              View Full Gallery
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
            </Link>
          </div>
      ...
      <section className="py-20 bg-accent">
        <div className="container mx-auto px-6 max-w-4xl text-center text-white">
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">Ready to collaborate or connect?</h2>
          <p className="text-lg text-blue-100 mb-10">Whether you are a publisher, journalist, event organizer, or fellow cultural advocate — Kanenus is ready to hear from you.</p>
