...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    books: {
      ...
      b2Desc: '"Dhaloota Mul\'ataa" is Kanenus Kasa Bayisa\'s groundbreaking second major book. A visionary work dedicated to the emerging generation, it weaves profound philosophy, cultural consciousness, and personal empowerment into an unforgettable guide for future leaders.',
      preorderBtn: '📲 Order via WhatsApp',
      waitlistLabel: 'Also Available via Telegram:',
      waitlistPlaceholder: '',
      joinWaitlistBtn: '✈️ Order via Telegram',
      waitlistSuccess: "✓ Thank you! Your order has been received for Dhaloota Mul'ataa.",
  ...
  om: {
    ...
    home: {
      ...
      booksHeading: 'Kitaabota Maxxanfaman',
      ...
      b2Badge: 'Maxxanfame 2026 • 2ffaa',
      b2Desc: "Kitaaba lammaffaa dhaloota haaraa mul'ata qabu ijaaruuf maxxanfame.",
      b2Btn: 'Amma Bitadhu',
    ...
    books: {
      ...
      b2Desc: '"Dhaloota Mul\'ataa" kitaaba lammaffaa Kanenus Kasa Bayisaatiin maxxanfamedha. Kitaabni kun dhaloota haaraa mul\'ata qabu ijaaruu, aadaa fi ammayyummaa wal-simsiisuu, fi dhaloota gara fuulduraatti deemsisuuf gumaacha olaanaa qaba.',
      preorderBtn: '📲 WhatsApp irratti Bitadhu',
      waitlistLabel: 'Telegram Irrattis Ni Argama:',
      waitlistPlaceholder: '',
      joinWaitlistBtn: '✈️ Telegram irratti Bitadhu',
      waitlistSuccess: "✓ Galatoomaa! Ajajni keessan Dhaloota Mul'ataatiif galmaa'eera.",
  ...
  am: {
    ...
    home: {
      ...
      b2Sub: 'ሁለተኛ መጽሐፍ — ታትሟል',
      b2Badge: 'ታትሟል 2026 • 2ኛ',
      b2Desc: 'ለአዲሱ ትውልድ ራዕይ፣ ፍልስፍና እና አመራር የሚያስተምር ድንቅ መጽሐፍ።',
      b2Btn: 'አሁን ይዘዙ',
    ...
    books: {
      ...
      b2Desc: '"ደሎታ ሙልአታ" በቀነኑስ ካሳ ባይሳ የታተመ ሁለተኛው ትልቅ መጽሐፍ ነው። ራዕይ ያለው አዲስ ትውልድ ለመገንባት እና ባህልን ከዘመናዊነት ጋር ለማስተሳሰር ትልቅ ድርሻ አለው።',
      preorderBtn: '📲 በWhatsApp ይዘዙ',
      waitlistLabel: 'በTelegramም ይገኛል:',
      waitlistPlaceholder: '',
      joinWaitlistBtn: '✈️ በTelegram ይዘዙ',
      waitlistSuccess: '✓ እናመሰግናለን! ትዕዛዝዎ ለደሎታ ሙልአታ ተመዝግቧል።',
